  ...
  return (
    <Panel title="Top Losers (Stocks)" className="h-full flex flex-col">
      <div className="flex flex-col items-center justify-center text-center p-8 flex-1 bg-card/10 rounded-xl border border-border/30">
        <TrendingDown className="size-10 text-muted-foreground/30 mb-4" />
        ...
        <p className="text-[13px] text-muted-foreground mt-2 max-w-[280px]">
          Live Top Losers mapping requires an upgraded market-data subscription. We strictly enforce zero fake data.
        </p>
