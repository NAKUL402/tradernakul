    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-10">
      ...
      <div className="glass relative w-full max-w-md animate-rise rounded-3xl p-6 sm:p-8 text-center">
        ...
        <div className="mt-8">
          ...
          <h1 className="mt-4 font-display text-2xl font-semibold">Free Open Access Active</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            No login, passwords, or verification required! All features and dashboard analytics are fully unlocked.
          </p>
