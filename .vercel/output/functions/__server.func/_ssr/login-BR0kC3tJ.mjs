...
//#region node_modules/.nitro/vite/services/ssr/assets/login-BR0kC3tJ.js
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							...
							children: "Free Open Access Active"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 text-sm text-muted-foreground",
							children: "No login, passwords, or verification required! All features and dashboard analytics are fully unlocked."
						}),
