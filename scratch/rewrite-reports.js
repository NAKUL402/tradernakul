  ...
  const floatingButtons = `
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
        <button 
          ...
          className="flex size-10 items-center justify-center rounded-full bg-zinc-800 border border-zinc-700/50 text-zinc-300 shadow-xl hover:bg-zinc-700 hover:text-white transition-all hover:scale-105 active:scale-95"
        >
        ...
        <button 
          ...
          className="group relative flex size-14 items-center justify-center rounded-full bg-[#4f2a96] text-white shadow-[0_0_30px_rgba(100,50,200,0.4)] transition-all hover:scale-105 hover:bg-[#5a33a8] hover:shadow-[0_0_40px_rgba(100,50,200,0.6)] active:scale-95"
        >
...
const eqDropdown = `action={
              <button className="flex items-center gap-1.5 rounded-lg border border-zinc-800/80 bg-zinc-900/50 px-2 py-1 text-[11px] font-medium text-slate-300 transition-colors hover:bg-zinc-800">
                Cumulative PnL
...
const newDateRange = \`<div className="relative flex items-center">
            <Calendar className="pointer-events-none absolute left-3 size-3.5 text-slate-400" />
            <select
              aria-label="Select date range"
              value={dateRange}
...
// Make tables wrap nowrapping cells
code = code.replace(
